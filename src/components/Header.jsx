import { Bell, Dot, Search, Sidebar, SidebarClose, SidebarOpen } from "lucide-react";
    ...
    <header className="p-6 border-b">
      <div className="flex items-center justify-between flex-wrap">
        ...
        <div className="flex items-center gap-4 lg:gap-6">
          ...
          <div className="flex items-center gap-2 sm:gap-4 xl:gap-6 text-xs text-contrast min-w-64">
            <h2>Dashboard</h2>
            <span>/</span>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div
            ...
            } items-center lg:gap-2 p-2 bg-neutral-200 border border-base_grey rounded-full focus:outline-none focus:ring-1 focus:ring-secondary focus:border-transparent text-contrast`}
          >
            ...
            <input
              ...
              placeholder="Search"
              className={`${
                open ? "w-64 lg:w-36 xl:w-64" : "w-64"
              } text-xs text-brand_color2 bg-transparent placeholder:text-xs border-0 focus:ring-0 focus:outline-none focus:border-0`}
            />
          </div>
        </div>
        ...
        <div className="flex gap-3 items-center">
          ...
          <div className="relative">
            <div className="text-contrast hover:text-secondary relative">
